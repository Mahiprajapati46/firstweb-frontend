...
const AdminMerchantDetail = () => {
    ...
    const handleStatusChange = async (status) => {
        const reason = status === 'REJECTED' ? prompt('MANDATORY: Reason for rejection?') :
            status === 'SUSPENDED' ? prompt('MANDATORY: Reason for suspension?') : '';

        if ((status === 'REJECTED' || status === 'SUSPENDED') && reason === null) return;
        if ((status === 'REJECTED' || status === 'SUSPENDED') && !reason.trim()) {
            toast.error(`${status} protocol requires a formal reason`);
            return;
        }
                ...
                <div className="flex gap-2">
                    {merchant.status === 'PENDING' && (
                        <>
                            ...
                            >
                                <UserCheck size={16} /> Authorize Entity
                            </button>
                            <button
                            ...
                            >
                                <UserX size={16} /> Deny Application
                            </button>
                        </>
                    )}
                    {merchant.status === 'APPROVED' && (
                        ...
                        >
                            <Shield size={16} /> Suspend Operations
                        </button>
                    )}
                    {merchant.status === 'SUSPENDED' && (
                        ...
                        >
                            <UserCheck size={16} /> Restore Operations
                        </button>
                    )}
                </div>
            </div>
            ...
            <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-xl relative overflow-hidden group">
                ...
                <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-gray-400 font-mono text-xs font-black uppercase tracking-[0.2em] italic">System Identifier: {merchant._id}</p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-lg space-y-6">
                    <div className="flex items-center gap-3 border-b border-gray-50 pb-4">
                        ...
                        <h2 className="text-sm font-black text-primary uppercase tracking-widest">Business Contact Hub</h2>
                    </div>
                ...
                <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-lg space-y-6">
                    <div className="flex items-center gap-3 border-b border-gray-50 pb-4">
                        ...
                        <h2 className="text-sm font-black text-primary uppercase tracking-widest">Operational Headquarters</h2>
                    </div>
                ...
                <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-lg space-y-6">
                    <div className="flex items-center gap-3 border-b border-gray-50 pb-4">
                        ...
                        <h2 className="text-sm font-black text-primary uppercase tracking-widest">Store Inventory & Origin</h2>
                    </div>
                        ...
                        {merchant.rejection_reason && (
                            <div className="p-4 bg-rose-50 rounded-2xl border border-rose-100">
                                <span className="text-[10px] font-black text-rose-400 uppercase tracking-widest flex items-center gap-2 mb-2">
                                    <ShieldAlert size={14} /> Audit Note
                                </span>
                ...
                <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-lg space-y-6">
                    <div className="flex items-center gap-3 border-b border-gray-50 pb-4">
                        ...
                        <h2 className="text-sm font-black text-primary uppercase tracking-widest">Principal Identity</h2>
                    </div>
